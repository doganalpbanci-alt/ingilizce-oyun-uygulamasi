var SoundManager = (function () {
  var ctx = null;
  var muted = localStorage.getItem("kav-muted") === "1";
  ...
  return {
    ...
    setMuted: function (value) {
      muted = value;
      localStorage.setItem("kav-muted", value ? "1" : "0");
      if (!value) primeOnce();
    },
    playFound: function () {
      withCtx(function (audio) {
        ...
        [659.25, 880, 1174.66].forEach(function (f, i) {
          tone(audio, f, t + i * 0.07, 0.1, "triangle", 0.22);
        });
      });
    },
    playWrong: function () {
      withCtx(function (audio) {
        var t = audio.currentTime;
        tone(audio, 180, t, 0.12, "sawtooth", 0.13);
      });
    },
    playWin: function () {
      withCtx(function (audio) {
